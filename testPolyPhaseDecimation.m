...
subplot(3,1,2);spectrumVisualizer(out2,0.5*1e6);
subplot(3,1,3);spectrumVisualizer(out4,0.25*1e6);
...
figure(2);
subplot(3,1,1);spectrumVisualizer(out1,1e6);
subplot(3,1,2);spectrumVisualizer(out2PolyPhase,0.5*1e6);
subplot(3,1,3);spectrumVisualizer(out4PolyPhase,0.25*1e6);
